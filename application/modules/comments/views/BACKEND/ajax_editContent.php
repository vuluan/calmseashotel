...
function showRequest(formData, jqForm, options) {
    ...
    if(form.nameAdmincp.value == ''|| form.addressAdmincp.value == '' || form.commentAdmincp.value == ''|| form.rateAdmincp.value == ''){
			...
			<div class="portlet-body form">
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
							...
							<div class="col-md-3">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									...
									<div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">
										<img src="<?=resizeImage(PATH_URL.DIR_UPLOAD_COMMENTS.$result->image,150, 150)?>" />
									</div>
									<?php }} ?>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Rate (1 to 5): <span class="required" aria-required="true">*</span></label>
							<div class="col-md-10"><input value="<?php if(isset($result->rate)) { print $result->rate; }else{ print '';} ?>" type="text" name="rateAdmincp" class="form-control"/></div>
						</div>

						<div class="form-group">
							<label class="control-label col-md-2">Comment:</label>
							<div class="col-md-10">
								<textarea rows="4" name="commentAdmincp" class="form-control"><?php if(isset($result->comment)) { print $result->comment; }else{ print '';} ?></textarea>
							</div>
						</div>

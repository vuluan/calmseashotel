...
function showRequest(formData, jqForm, options) {
	...
	if(form.dateAdmincp.value == '' || form.description_enAdmincp.value == '' || form.descriptionAdmincp.value == ''){
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="input-group date-picker input-daterange" data-date-format="yyyy/mm/dd">
									<input  type="text" class="form-control" name="dateAdmincp" id="dateAdmincp" value="<?php if(isset($result->date)) { print $result->date; }else{ print '';} ?>">
								</div>
							</div>
						</div>

...
function showRequest(formData, jqForm, options) {
	...
	if(form.titleAdmincp.value == '' || form.cateAdmincp.value == '' || form.descriptionAdmincp.value == '' || $('#contentAdmincp').val() == '<br>' || $('#contentAdmincp').val() == '' || ($('#contentAdmincp').val().charCodeAt(0)==10 && isNaN($('#contentAdmincp').val().charCodeAt(1)))){
			...
			<div class="portlet-body form">
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
							...
							<div class="col-md-3">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									...
									<div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">
										<img src="<?=resizeImage(PATH_URL.DIR_UPLOAD_OFFERS.$result->image,150, 150)?>" />
									</div>
									<?php }} ?>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Condition: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-4"><input value="<?php if(isset($result->condition)) { print $result->condition; }else{ print '';} ?>" type="text" name="conditionAdmincp" id="conditionAdmincp" class="form-control"/></div>
							<label class="control-label col-md-2">Discount: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-4"><input value="<?php if(isset($result->discount)) { print $result->discount; }else{ print '';} ?>" type="text" name="discountAdmincp" id="discountAdmincp" class="form-control"/></div>
						</div>
